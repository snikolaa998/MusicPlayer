...
class FirebaseMusicSource @Inject constructor(private val musicDatabase: MusicDatabase) {
    ...
    //Lista sa meta podacima o pesmama(slicno kao klasa song)
    var songs = emptyList<MediaMetadataCompat>()

    //funkcija za dobijanje song objekta od firebase-a
    //withContext nam menja trenutni thread u kom se izvrsava corotuina -> IO thread je za operacije sa bazama/network
    ...
    //Znaci nam da bismo mogli da pustamo pesmu za pesmom
    ...
    //Znaci nam da ako zelimo da kliknemo na trenutnu pesmu
