...
class MusicNotificationManager(
    ...
    //Custom klasa notification managera koja nam pomaze oko kreiranja notifikacije
    ...
    private inner class DescriptionAdapter(
        ...
        override fun getCurrentContentTitle(player: Player): CharSequence {
            //Vraca nam trenutni title pesme(to mozemo da uradimo pomocu mediaController)
